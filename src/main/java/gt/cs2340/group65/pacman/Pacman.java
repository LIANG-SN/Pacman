...
class Pacman extends ImageView {
    ...
    public void moveLeft() {
        setX(getX() - 2);
        try {
            setImage(new Image(new FileInputStream("src/main/resources/gt/cs2340/group65/pacman/" + color + "PacmanLeft.png")));
        }
        catch(Exception e) {
            System.out.println("something was wrong with image file");
        }
    ...
    public void moveRight() {
        setX(getX() + 2);
        try {
            setImage(new Image(new FileInputStream("src/main/resources/gt/cs2340/group65/pacman/" + color + "PacmanRight.png")));
        }
        catch(Exception e) {
            System.out.println("something was wrong with image file");
        }
